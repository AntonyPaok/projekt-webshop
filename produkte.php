...
<body>
    ...
    while ($produkt = $result->fetch_assoc() ) {
        echo "<div class=\"#\"><tr>";
        echo "<div class=\"#\"><td> <img src=\"https://via.placeholder.com/512x256\" alt=\"$produkt[ProduktName]\"> </td></div>";
        echo "<div class=\"#\"><td> $produkt[ProduktName] </td></div>";
        echo "<div class=\"#\"><td> $produkt[Nettopreis] </td></div>";
        echo "</tr></div>";
        }
    ?>
        </table>
